...
%define kernel_ver	4.18.0-147.5.1.el8_1
...
# Workaround bz-1753272, disable debug packaging and the os_install_post
# compression/stripping to avoid missing klp relocation sections
...
%changelog
* Mon Jan 20 2020 Yannick Cote <ycote@redhat.com> [0-0.el8]
- An empty patch to subscribe to kpatch stream for kernel-4.18.0-147.5.1.el8_1 [1793106]
